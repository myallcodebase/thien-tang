...
const Page = ({ data, isPreview, deactivatePreviewMode, posts }: Props) => {
  ...
  const renderNavbar = () => {
    ...
    return (
      <Navbar
        socialMediaIcons={patchedIcons}
        navigationLinks={filteredNavLinks}
  ...
  const renderFooter = () => {
    ...
    const filteredFooterLinks = navigationLinks.filter((link) => link.url !== "/blog");

    return (
      <Footer
        copyrightText={copyrightText}
        navigationLinks={filteredFooterLinks}
